...
class Predpriyatie(models.Model):
    ...
    sh_name = models.CharField(max_length=20, blank = False, unique=True, verbose_name="Сокращенное наименование")
    address = models.CharField(max_length=60, blank = False, unique=True,  verbose_name="Адрес")
    ...
    vid_hoz_d = models.ForeignKey(VHD, on_delete=models.CASCADE,  verbose_name="Код основного вида хозяйственной деятельности")
...
class PB(models.Model):
    bin_pb = models.ForeignKey(Predpriyatie, on_delete=models.CASCADE, verbose_name="БИН")
...
class FP(models.Model):
    ...
    date = models.DateField(verbose_name="Год")
